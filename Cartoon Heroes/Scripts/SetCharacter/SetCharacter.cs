...
namespace CartoonHeroes
{
    public class SetCharacter : MonoBehaviour
    {
        ...
        {
            Debug.Log("SetGraySkeletonVisibility(bool set)");
            if (!set)
            {
        ...
        {
            Debug.Log("ParentObjectAndBones(GameObject itemInstance)");
            Transform[] allCharacterChildren = GetAllCharacterChildren();
        ...
        {
            Debug.Log("GetAllCharacterChildren()");
            Transform root = GetRoot();
        ...
        {
            Debug.Log("BelongsToItem(Transform obj, ItemGroup itemGroup, int itemSlot)");
        ...
        {
            Debug.Log("RemoveAnimator(GameObject item)");
        ...
        {
            Debug.Log("MatchTransform(Transform obj, Transform target)");
        ...
        {
            Debug.Log("GetRemoveObjList(ItemGroup itemGroup, int itemSlot)");
